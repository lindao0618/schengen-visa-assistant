...
import { buildApplicantSchengenIntakeView } from "@/lib/agent-file-parsing"
...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  const intake = await buildApplicantSchengenIntakeView(actor.userId, params.id, actor.role)
  if (!intake) {
