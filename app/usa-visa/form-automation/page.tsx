...
const USAVisaClientPage = dynamic(() => import("../USAVisaClientPage"), {
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pt-36 dark:from-gray-900 dark:to-black">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8 space-y-4 text-center">
          <div className="mx-auto h-12 w-80 max-w-full animate-pulse rounded-2xl bg-gray-200 dark:bg-gray-800" />
...
export default function USAVisaFormAutomationPage() {
