...
const ds160FormSchema = z.object({
  ...
  formerNames: z.array(z.object({
    lastName: z.string().min(1, { message: "曾用姓氏不能为空" }),
    firstName: z.string().min(1, { message: "曾用名字不能为空" })
  })).optional(),
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：ZHANG" {...field} />
                          </FormControl>
                          <FormDescription>
                            请使用护照上的拼音姓氏，全部大写
                          </FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：SAN" {...field} />
                          </FormControl>
                          <FormDescription>
                            请使用护照上的拼音名字，全部大写
                          </FormDescription>
                    ...
                    <div className="space-y-4">
                            ...
                            <FormControl>
                              <Select
                                onValueChange={(value) => {
                                  ...
                                  if (value === 'no') {
                                    form.setValue('formerNames', []);
                                  } else if (value === 'yes' && !form.getValues('formerNames')?.length) {
                                    form.setValue('formerNames', [{ lastName: '', firstName: '' }]);
                                  }
                                }}
                                value={field.value}
                      ...
                      {form.watch('hasFormerName') === 'yes' && (
                        <div className="pt-4 animate-in fade-in-0 slide-in-from-top-5 duration-300">
                          <FormField
                            control={form.control}
                            name="formerNames"
                            render={({ field }) => (
                                  ...
                                  {field.value?.map((_, index) => (
                                    <div key={index} className="space-y-4 rounded-lg border p-4">
                                      <div className="flex justify-between items-center">
                                        <h4 className="text-sm font-medium">曾用名 {index + 1}</h4>
                                        <Button
                                          type="button"
                                          variant="ghost"
                                          size="sm"
                                          ...
                                          onClick={() => {
                                            ...
                                            form.setValue('formerNames', newNames);
                                          }}
                                        >
                                          删除
                                        </Button>
                                      ...
                                      <div className="grid gap-4 sm:grid-cols-2">
                                        <FormField
                                          control={form.control}
                                          name={`formerNames.${index}.lastName`}
                                          render={({ field }) => (
                                            <FormItem>
                                              <FormLabel>曾用姓氏</FormLabel>
                                              <FormControl>
                                                <Input {...field} />
                                              </FormControl>
                                              <FormMessage />
                                        ...
                                        <FormField
                                          control={form.control}
                                          name={`formerNames.${index}.firstName`}
                                          render={({ field }) => (
                                            <FormItem>
                                              <FormLabel>曾用名字</FormLabel>
                                              <FormControl>
                                                <Input {...field} />
                                              </FormControl>
                                              <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：CHINA" {...field} />
                          </FormControl>
                          <FormDescription>
                            请输入您的出生国家，全部大写
                          </FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：SHANDONG" {...field} />
                          </FormControl>
                          <FormDescription>
                            请输入您的出生省份，全部大写
                          </FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：JINAN" {...field} />
                          </FormControl>
                          <FormDescription>
                            请输入您的出生城市，全部大写
                          </FormDescription>
              ...
              {formStep === 1 ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold">第二步：联系方式信息</h2>
                    <Badge variant="outline" className="text-sm">
                      步骤 2/3
                    </Badge>
                  </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="例如：E12345678" {...field} />
                          </FormControl>
                          <FormDescription>
                            请输入您的护照号码
                          </FormDescription>
...
export default DS160DirectForm;
