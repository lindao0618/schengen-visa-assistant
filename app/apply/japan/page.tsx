...
const JapanVisaApplicationClientPage = dynamic(() => import("./JapanVisaApplicationClientPage"), {
  ssr: false,
  loading: () => (
...
export default function JapanVisaApplicationPage() {
  return <JapanVisaApplicationClientPage />
}
